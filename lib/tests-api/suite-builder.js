...
module.exports = function(suite) {
    ...
    this.setCaptureArea = function() {
        if (!arguments[0] && typeof arguments[0] !== 'object') {
            throw new TypeError('suite.captureArea shoud be an object with "height" and "width" fields');
        }

        suite.captureArea = arguments[0];
    ...
    this.capture = function capture(name, opts, cb) {
        ...
        if ('captureArea' in opts) {
            if (typeof opts.captureArea !== 'object') {
                throw new TypeError('captureArea shoud be an object');
            }
            state.captureArea = opts.captureArea;
        }
